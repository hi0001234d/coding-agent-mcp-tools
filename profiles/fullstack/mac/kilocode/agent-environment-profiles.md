# 🚀 Full-stack Dev Stack (macOS + VS Code + KiloCode)

This profile provides a ready-to-use **full-stack development environment** for coding agents using MCP tools on macOS.
